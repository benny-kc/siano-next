...
Origin/trip-id rejection, rate limit, headers).
...
`SIANO_PEER_TOKEN`, `SIANO_DEBUG`, `SIANO_CLIENT_DEBUG`, `SIANO_ASSET_HASHING`,
`SIANO_CACHE_CONTROL`, `SIANO_CDN_CACHE_CONTROL`, `SIANO_SW_CACHE_CONTROL`.
